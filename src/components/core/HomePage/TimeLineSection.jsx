...
const TimeLineSection = () => {
  return (
    <>
      <div className="w-11/12 h-fit flex gap-20 relative">
        <div className="w-[410px] h-max flex flex-col gap-8 my-auto">
        ...
        <div className="max-w-maxContent max-h-fit relative">
          <img
            src={timeLineImage}
            className="w-[714px] h-[545px] shadow-[20px_20px_0px_0px_#F5F5F5] z-10"
          ></img>
          {/* <div
          ...
          blur-3xl "
          ></div> */}
          <div className="absolute max-w-[511px] max-h-[128px] p-10 flex flex-row gap-10 bg-caribbeangreen-700 items-center right-[50px] -bottom-[55px]">
            ...
            <div className="w-[44px] h-0 border-[1px] border-[#037957] rotate-90"></div>
            <div className="max-w-[161px] max-h-[44px] gap flex gap-5">
              <p className="font-bold text-4xl font-inter text-center tracking-tight text-white">
                250
              </p>
