    ...
    <div
      className={`${
        isActive
          ...
          : "bg-richblack-800"
      } max-w-[343.33px] max-h-[300px] flex flex-col gap-2 md:gap-3`}
    >
      <div
        className={` w-full h-72 md:max-h-fit flex flex-col gap-3 pt-8 px-6 pb:6 md:pb-12 font-inter`}
      >
        <p
          className={`${
      ...
      <div
        ...
        } w-full max-h-[56px]  md:mt-4 pt-4 pb-2 md:pb-2 px-6 flex items-center gap-4 border-t-[2px] border-dashed justify-between`}
      >
